...
<head>
    ...
    <style>
        ...
        .hero-section {
            background: url('https://source.unsplash.com/1200x400/?market,food') no-repeat center center;
...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-bold" href="#">BUMDes Spirit Mejabar</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="/promosi-umkm">Promosi UMKM</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<!-- Footer -->
<div class="footer">
    <p>&copy; 2025 BUMDes Spirit Mejabar | Desa Mejaseem, Tegal, Jawa Tengah</p>
</div>
